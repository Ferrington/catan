...
import {Board, Tile} from "../../types/types.ts";
import {
  BOARD_HEIGHT,
  BOARD_WIDTH,
  ROW_OFFSET,
    ...
    const data = [
      {
        ...
        top: (tile: Tile) => {
          return tile.top - VERTEX_HEIGHT + TILE_GAP / 2 + 4;
        },
        left: (tile: Tile) => {
      ...
      },
      {
        ...
        coords: new HexCoordinate(coords.x - 0.5, coords.y + 0.5, coords.z - 0.5),
        top: (tile: Tile) => {
          return tile.top - VERTEX_HEIGHT / 1.3 + TILE_HEIGHT / 4 - (TILE_GAP - VERTEX_HEIGHT) / 2 - 2;
        },
        left: (tile: Tile) => {
      ...
      },
      {
        ...
        coords: new HexCoordinate(coords.x - 0.5, coords.y + 0.5, coords.z + 0.5),
        top: (tile: Tile) => {
          return tile.top + TILE_HEIGHT / 4 * 3 - 8;
        },
        left: (tile: Tile) => {
          return tile.left + TILE_WIDTH + 1 + (TILE_GAP - VERTEX_WIDTH) / 2;
        },
