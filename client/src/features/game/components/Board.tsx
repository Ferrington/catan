...
import {Board as BoardType, Edge as EdgeType, Tile as TileType, Vertex as VertexType} from "../../types/types.ts";
import Vertex from "./Vertex.tsx";
import Edge from "./Edge.tsx";


export default function Board() {
  const {tiles, vertices, edges} = useSnapshot<BoardType>(store.board);
